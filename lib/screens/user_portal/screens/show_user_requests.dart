...
import 'package:blood_bank/screens/user_portal/widgets/request_item_trait_user.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class ShowUserRequests extends StatefulWidget {
  const ShowUserRequests({super.key});

  @override
  State<ShowUserRequests> createState() => _UserRequestItemState();
}

class _UserRequestItemState extends State<ShowUserRequests> {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            return RequestItemTraitUser(donationRequest: _userRequests[index]);
          }),
    );
  }
}
